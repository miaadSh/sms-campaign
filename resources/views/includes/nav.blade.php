    ...
    <nav class="bg-gray-800">
        ...
        <div class="flex items-center justify-between h-16">
          <div class="flex items-center">
            ...
            <div class="hidden md:block">
              ...
              <a href="{{ route('dashboard.index') }}" class="px-3 py-2 rounded-md text-sm font-medium text-white bg-gray-900">داشبورد</a>
          ...
          <div class="hidden md:block">
            <div class="ml-4 flex items-center md:ml-6">
              <button class="bg-gray-800 p-1 rounded-full text-gray-400 hover:text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-offset-gray-800 focus:ring-white">
                <span class="sr-only">مشاهده پیغام ها</span>
                <!-- Heroicon name: bell -->
      ...
      <div class="hidden md:hidden">
        <div class="px-2 pt-2 pb-3 space-y-1 sm:px-3">
          ...
          <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700">مدیریت کمپین ها</a>

          <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700">مدیریت گروه ها</a>

          <a href="#" class="block px-3 py-2 rounded-md text-base font-medium text-gray-300 hover:text-white hover:bg-gray-700">مدیریت پیش نویس ها</a>
        </div>
